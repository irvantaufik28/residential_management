class AuthUC {
  ...
  async register(userData) {
    ...
    await this.EmailRepository.sendNotificationRegisterForAdmin(admin.email, userData)
    await this.EmailRepository.sendNotificationRegisterForUser(userData.email, userData)
